...
const tabs = [
  ...
  { label: "Endpoints", to: "/settings", icon: FolderCog },
      ...
      <div className="px-4 py-4 md:px-6">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-emerald-500/10 bg-white/80 text-slate-700 shadow-sm shadow-emerald-950/5 dark:border-emerald-400/10 dark:bg-white/[0.03] dark:text-emerald-100">
